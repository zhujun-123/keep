	...
	<view class="content">
		...
		<view class="notice">
			<view class="noticeItem">
				<image src="../../static/content/pingpai.png" mode=""></image>
				自营品牌
			</view>
			<text class="text">|</text>
			<view class="noticeItem">
				<image src="../../static/content/leidian.png" mode=""></image>
				课程同款
			</view>
			<text class="text">|</text>
			<view class="noticeItem">
				<image src="../../static/content/7tian.png" mode=""></image>
				7 日退换
			</view>
		</view>
		...
		<view class="cateOne">
			...
			<view class="product">
				<view class="productItem" v-for="(item, index) in list" :key="index">
					<image :src="item.shopImg" mode="" />
					<text class="productName">{{item.shopName}}</text>
					<view class="productDetail">
						<view class="mark">{{item.mark}}</view>
						<view class="detailInfo">{{item.shopDetail}}</view>
					</view>
	...
	export default {
		data() {
			return {
				...
				list: [
					{
							shopImg: "../../static/image/p1.png",
							shopName: "魅族 16s Pro",
							mark: "免息",
							shopDetail: "4800W AI三摄 屏幕下指纹",
							price: 2699
					},
					{
							shopImg: "../../static/image/p1.png",
...
<style>
	...
	.recommend .recommendItem image {
		width: 100rpx;
		height: 100rpx;
	}

	.recommend .recommendItem text {
		display: block;
		font-size: 24rpx;
		line-height: 70rpx;
	}
	...
	.cateRecommendItem image {
		width: 375rpx;
		height: 330rpx;
	}

	.cateRecommendItem view {
		width: 375rpx;
		height: 330rpx;
		color: #fff;
	}

	.cateRecommendItem view .title {
		font-size: 30rpx;
		padding-left: 30rpx;
		display: block;
		line-height: 48rpx;
	...
	.cateRecommendItem view .goodinfo {
		font-size: 22rpx;
		display: block;
